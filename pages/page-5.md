...
<div class="flex flex-col transition-800 w-auto lh-2 text-coolgray-300 text-4">
...
<div v-click="2" class="flex flex-col transition-800 w-auto lh-2 text-coolgray-300 text-6">
...
<div v-click="3" class="flex flex-col transition-800 w-auto lh-2 text-coolgray-300 text-4">
  <span>
